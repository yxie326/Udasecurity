...
public class PretendDatabaseSecurityRepositoryImpl implements SecurityRepository{
    ...
    private boolean cameraShowsCat;
    ...
    public void setCameraShowsCat(boolean cameraShowsCat) {
        this.cameraShowsCat = cameraShowsCat;
        // TODO: Not sure how to handle prefs. I'm leaving it here
    }
    ...
    @Override
    public boolean isCameraShowsCat() { return cameraShowsCat;}
}
